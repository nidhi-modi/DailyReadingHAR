...
import {GET_DAILY_READINGS_HAR} from '../graphql/queries';
...
export const GetAwsData = props => {
  ...
  const [getQuery] = useLazyQuery(GET_DAILY_READINGS_HAR, {
    fetchPolicy: 'no-cache',
    onCompleted: data => {
      loading = false;
      setDailyReadings(data?.daily_readings);
      console.log('Data loaded from AWS ');

      try {
        AsyncStorage.setItem(
          '@MySuperStore:readingsHarKey',
          JSON.stringify(data),
        );
